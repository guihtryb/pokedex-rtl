...
Nesse projeto escrevi testes para uma aplicação React de uma Pokédex.


### Para executar o projeto em sua máquina:

1. Clone o repositório
  * `git@github.com:guihtryb/pokedex-rtl.git`.
...
### Quem testou os testes?

  Esse trabalho contou com um avaliador automatizado que **testam os testes**. A ideia dele é a seguinte: eu escrevo casos de teste para a aplicação, e esses testes têm que garantir que a aplicação está funcionando. Quebrando uma parte da aplicação, fazendo uma alteração no código, meus testes devem quebrar, certo? E é Deste modo que o avaliador funciona.
